            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white border-4 border-brand-black shadow-neo p-8">
                    ...
                    <form onSubmit={handleRegister} className="space-y-4">
                        <div>
                            <label className="block text-sm font-bold uppercase mb-2">Kullanıcı Adı</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className={`w-full pl-11 pr-4 py-3 border-2 ${usernameError ? "border-red-500" : "border-brand-black"} focus:outline-none focus:ring-2 focus:ring-brand-yellow`}
                    ...
                    <p className="mt-6 text-center text-sm text-gray-600">
                        ...
                        <Link href="/login" className="font-bold text-brand-black hover:text-brand-red">
                            Giriş Yapın
                        </Link>
                    </p>
                </div>
